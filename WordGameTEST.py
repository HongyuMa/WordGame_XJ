...
# Please do NOT POST or SHARE these
# problems or your solutions anywhere! thx

Note:  you may have issues reading the file Bierce.txt.  It is NOT
essential to the project, you should be able to get everything to
work without using that file.
...
Note, if you have trouble reading the file Bierce.txt you could just use
another text file with words inside.
